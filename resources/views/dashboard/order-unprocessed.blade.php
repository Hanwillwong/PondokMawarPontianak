    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <div class="text-tiny">Unprocessed Orders</div>
                </li>
            </ul>
        </div>
        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                <div class="wg-filter flex-grow ">
                    ...
                    <div>
                        <a href="{{ route('order.unprocessed', ['type' => 'pickup']) }}" class="btn btn-outline-primary {{ request('type') === 'pickup' ? 'active' : '' }}">
                            Pickup
                        </a>
                        <a href="{{ route('order.unprocessed', ['type' => 'delivery']) }}" class="btn btn-outline-success {{ request('type') === 'delivery' ? 'active' : '' }}">
                            Delivery
                        </a>
                        <a href="{{ route('order.unprocessed') }}" class="btn btn-outline-secondary {{ is_null(request('type')) ? 'active' : '' }}">
                            All 
                        </a>
                    </div>
                </div>
